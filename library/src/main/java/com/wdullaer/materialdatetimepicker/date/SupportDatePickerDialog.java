    ...
    DatePickerController
{
  ...
  @Setter
  private Action1<Calendar> callBack;
   ...
   */
  public static SupportDatePickerDialog newInstance(int year, int monthOfYear, int dayOfMonth, Action1<Calendar> mCallBack)
  {
    SupportDatePickerDialog ret = new SupportDatePickerDialog();
    ret.initialize(mCallBack, year, monthOfYear, dayOfMonth);
    return ret;
  }

  public void initialize(Action1<Calendar> callBack, int year, int monthOfYear, int dayOfMonth)
  {
