 ...
 * 可展开的文字
 *
 * @see <a href='https://github.com/puppet2436/ExpandableTextView'>ExpandableTextView</a>
 */
public class ExpandableTextLayout extends LinearLayout implements View.OnClickListener
{
  ...
  protected ZImageView mButton; // Button to expand/collapse
  ...
  private void init(AttributeSet attrs)
  {
    ...
    if (mExpandDrawable == null) {
      mExpandDrawable = getDrawable(getContext(), R.mipmap.ic_expand);
    }
    if (mCollapseDrawable == null) {
      mCollapseDrawable = getDrawable(getContext(), R.mipmap.ic_collapse);
    }
  ...
  {
    int c = getChildCount();
    for (int i = 0; i < Math.min(c, 2); i++) {
      View child = getChildAt(i);
      if (child instanceof TextView) {
        mTv = (TextView) child;
        mTv.setOnClickListener(this);
      } else if (child instanceof ZImageView) {
        mButton = (ZImageView) child;
        mButton.setImageDrawable(mCollapsed ? mExpandDrawable : mCollapseDrawable);
