...
public class FastJsonConverterFactory extends Converter.Factory
{
  ...
  {
    FastJsonResponseBodyConverter<?> converter = new FastJsonResponseBodyConverter<>(type, mParserConfig, featureValues, features);
    converter.setResTransformer(resTransformer);
    return converter;
  }
